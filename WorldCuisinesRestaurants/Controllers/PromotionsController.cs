...
namespace WorldCuisinesRestaurants.Controllers
{
    public class PromotionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Description,StartDate,EndDate")] Promotion promotion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Description,StartDate,EndDate")] Promotion promotion)
        {
            if (ModelState.IsValid)
            {
