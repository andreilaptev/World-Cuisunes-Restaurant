...
namespace WorldCuisinesRestaurants.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Street,City,ZipCode")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Street,City,ZipCode")] Address address)
        {
            if (ModelState.IsValid)
            {
